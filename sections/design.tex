...
\todo{add graphics to help understand the cache chunks hit delta}
...
\todo{explain what the lock is for}
...
\label{sec:profiling}
\rashmi{Combine this and the below section into one "Debugging and Profiling Infrastructure"}
